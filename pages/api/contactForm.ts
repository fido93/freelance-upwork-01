...
const sendContactForm = async (req: NextApiRequest, res: NextApiResponse) => {

  if(req.method === "POST") {
    const msg = {
      to: 'malayauchi@gmail.com', // Change to your recipient
      from: 'affiliate-contact@malayauchi.com', // Change to your verified sender
      subject: `Received contact request from ${req.body.name} `,
