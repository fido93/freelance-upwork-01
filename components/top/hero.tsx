import { Box, BoxProps, Container, Flex, FlexProps, Text, useBreakpointValue } from "@chakra-ui/react";
...
function Hero(props: BoxProps) {
  const heroBg = "linear-gradient(153deg, rgba(255,255,255,1) 0%, rgba(68,68,68,1) 0%, rgba(0,0,0,1) 29%, rgba(0,0,0,1) 100%);"
  return (
  ...
  return (
    <Box {...props} >
      ...
      <Flex justifyContent={"space-between"} py="2em" w="70%">
        {portfolios.map((p, i) => <Portfolio key={i} {...p} />)}
      </Flex>
    </Box>
  )
}
